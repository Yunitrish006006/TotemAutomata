...
class CopperGolemMenuPayloadStateTest {
    @Test void holdsOtherGolemPayloadUntilItsScreenOpens() {
        UUID id = UUID.randomUUID(); CopperWrenchBindingsPayload payload = new CopperWrenchBindingsPayload(id, 0, false, "sorting", "stopped", "minecraft:air", 0, 0, "minecraft:air", 0, 0, 0, "minecraft:air", 0, "", "", "", 0, null, null, List.of(), false, "", 0, 0, List.of(), List.of(), List.of(), List.of(), List.of());
