...
LLM 非同步測試的詳細約束記錄於 `docs/developer/copper-golem-llm-testing.md`。

仍需保留在 OpenSpec 的項目包括完整自主採集／尋路、區塊卸載、Copper Golem 跨 JVM world probe，以及多人同 tick 壓力競態。
